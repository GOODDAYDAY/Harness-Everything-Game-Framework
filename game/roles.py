...
class Role(Enum):
    ...
    # Independent
    TOWN_CRIER = ("town_crier", Team.INDEPENDENT, "Wins if voted out during the day.")
...
ROSTER_12_PLAYER: list[Role] = [
    ...
    Role.GUARD,      # 1 guard
    Role.WEREWOLF, Role.WEREWOLF, Role.WEREWOLF,  # 3 werewolves
    Role.TOWN_CRIER,  # 1 town crier
]
