...
class TestVillageRenderer:
    ...
    def test_get_background_day_returns_surface(self):
        ...
        assert bg.get_size() == (VIEWPORT_W, VIEWPORT_H)
...
class TestConstants:
    ...
    def test_grid_dimensions_match_viewport(self):
        """Grid cols/rows match viewport / tile_size."""
        assert GRID_COLS == VIEWPORT_W // TILE_SIZE  # 32
        assert GRID_ROWS == VIEWPORT_H // TILE_SIZE  # 18
